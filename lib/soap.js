...
function expressService(pathOrOptions, services, xml) {
    var options = {},
        path = pathOrOptions;
    ...
    var wsdl = new WSDL(xml || services, null, options);
    var soapServer = new Server(null, path, services, wsdl);

    return function wsdl(req, res, next) {
	soapServer.handleRequest(req, res);
